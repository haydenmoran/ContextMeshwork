// src/lib.rs
/*
 * Core library for ContextMeshwork
 */
...
#[derive(Debug)]
pub struct ContextMeshworkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContextMeshworkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContextMeshwork processing");
    
    let mut processor = ContextMeshworkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContextMeshworkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContextMeshworkProcessor::new(false);
